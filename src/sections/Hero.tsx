        ...
        <div className="container">
          <div className="relative z-2 max-w-512 max-lg:max-w-388">
            ...
            <h1 className="h1 max-lg:h2 mb-6 uppercase text-p4 max-lg:mb-7 max-md:mb-4 max-md:text-5xl max-md:leading-12">
              Stop Losing Track of What Matters Most in Your Meetings
            </h1>

            <p className="max-2-440 body-1 mb-14 max-md:mb-10">
              CoNNIE AI transforms every sales call, team meeting, and onboarding session into actionable insights and automated follow-ups.
            </p>

            <LinkScroll to="features" offset={-100} spy smooth>
              <Button icon="/images/zap.svg">Start Your Free Trial</Button>
            </LinkScroll>
          </div>
